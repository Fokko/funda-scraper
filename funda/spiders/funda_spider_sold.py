...
class FundaSoldSpider(CrawlSpider):
    ...
    def __init__(self, place='amsterdam'):
        self.start_urls = ["http://www.funda.nl/koop/verkocht/%s/p%s/" % (place, page_number) for page_number in
                           range(1, 200)]
    ...
    def parse_details(self, response):
        ...
        area_td = response.xpath("//th[contains(.,'woonoppervlakte')]/following-sibling::td[1]/span/text()").extract()[
            0]
